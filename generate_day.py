...
def create_data_file(year, day):
    ...
    data_file_path.parent.mkdir(parents=True, exist_ok=True)  # Create directory if it doesn’t exist
...
def create_solution_file(year, day):
    ...
    solution_file_path.parent.mkdir(parents=True, exist_ok=True)  # Create directory if it doesn’t exist
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate Advent of Code files for a specific day.")
